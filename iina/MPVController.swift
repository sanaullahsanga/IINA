...
class MPVController: NSObject {
  ...
  private func makeCArgstoopenvideo(_ command: MPVCommand, _ args: [String?]) -> [String?] {
  ...
  func commandtoOpenVideo(_ command: MPVCommand, args: [String?] = [], checkError: Bool = true, returnValueCallback: ((Int32) -> Void)? = nil) {
